...
variable "subnetwork_main" {
  type        = string
  description = "Name of the subnet wherein the compute engine instance will be created"
}

variable "subnetwork_backup" {
  type        = string
  description = "Name of the subnet wherein the backup compute engine instance will be created"
  default     = ""
}
...
variable "zone_backup" {
  type        = string
  description = "Zone suffix where the backup compute engine instance will be created"
  default     = ""
}
...
variable "ip_backup" {
  type        = string
  description = "Static IP address for the backup instance"
  default     = ""
}

// There are 2 separate variables defined so I can override the current main for non-prod

variable "metadata_startup_script_main" {
  type        = string
...
variable "metadata_startup_script_backup" {
  type        = string
  description = "Startup script to be executed on the compute engine instance"
  default     = <<-EOT
    #!/bin/bash
